...
const posts = [
  {
    ...
    content: `
      <p class="lead">Noam Chomsky argumenta que la perspectiva de la extinción humana surgió tras la Segunda Guerra Mundial, con el inicio de la era del Antropoceno[cite: 22].</p>
      ...
      <blockquote class="my-4">
        ...
        [cite_start]<footer class="blockquote-footer mt-2">Noam Chomsky [cite: 151]</footer>
      </blockquote>
      
      [cite_start]<p>Estamos inmersos en una sexta extinción masiva, pero esta vez, provocada por el ser humano[cite: 152, 155]. [cite_start]A diferencia de las anteriores, "los animales de mayor tamaño morirán desproporcionadamente"[cite: 158]. [cite_start]Las emisiones de CO2 están aumentando a la tasa más elevada en sesenta y seis millones de años [cite: 161][cite_start], y ya hemos superado el punto de peligro crítico de las cuatrocientas partes por millón[cite: 162, 164].</p>
    `
  },
  {
    id: 2,
    ...
    content: `
      ...
      <blockquote class="my-4">
        ...
        [cite_start]<footer class="blockquote-footer mt-2">Noam Chomsky [cite: 885]</footer>
      </blockquote>
  ...
  },
  {
    ...
    content: `
      ...
      [cite_start]<p>El libro destaca ejemplos de éxito, como la "ingente movilización popular de principios de los ochenta contra el desarrollo de las armas nucleares" [cite: 366] o, más recientemente, el <strong>Sunrise Movement</strong> en EE.UU.</p>
      ...
      <blockquote class="my-4">
        ...
        [cite_start]<footer class="blockquote-footer mt-2">Noam Chomsky [cite: 874]</footer>
      </blockquote>
